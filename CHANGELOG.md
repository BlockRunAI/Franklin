...
New no-spend regression tests cover the prefetch wire shape, the size-aware cost resolution, and the VoiceCall guard. Verified: local suite 471/471 (paid e2e additions gated behind `RUN_PAID_E2E=1`).
