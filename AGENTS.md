...
Open-source AI agent with a wallet. <!-- br:models.chatVisible -->77<!-- /br:models.chatVisible --> models. Pay per use with BlockRun API account credit or USDC wallets via x402.
