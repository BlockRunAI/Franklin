...
**<!-- br:models.chatVisible -->77<!-- /br:models.chatVisible --> models. One decision. Zero guesswork.**
...
| Picks best model per task              | ❌ single-vendor | ❌ plan-tied    | ❌               | ✅ **Smart Router, <!-- br:models.chatVisible -->77<!-- /br:models.chatVisible --> models** |
...
**🧠 <!-- br:models.chatVisible -->77<!-- /br:models.chatVisible --> models via one wallet**
...
Trained on 2M+ real requests. Classifies your task and picks the best model from <!-- br:models.chatVisible -->77<!-- /br:models.chatVisible --> LLMs. Four profiles (auto/eco/premium/free). Adapts to your usage over time.
...
├──────────────────────────────────────────────────────────────┤
│  Learned Router                                              │
│  2M+ requests · <!-- br:models.chatVisible@live -->77<!-- /br:models.chatVisible@live --> models · category detection · Elo scores │
├──────────────────────────────────────────────────────────────┤
│  Agent Loop                                                  │
│  16 tools · Sessions · Compaction · Pricing · Plugin SDK     │
├──────────────────────────────────────────────────────────────┤
│  BlockRun Gateway                                            │
│  <!-- br:models.chatVisible@live -->77<!-- /br:models.chatVisible@live --> LLMs · CoinGecko · Search · Image APIs · paid services  │
├──────────────────────────────────────────────────────────────┤
...
├── router/            Learned model router (<!-- br:models.chatVisible@live -->77<!-- /br:models.chatVisible@live --> models, Elo scoring)
