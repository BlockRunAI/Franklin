...
**BlockRun Gateway**:
The single upstream service Franklin calls for both LLM completions and paid tools (Exa, ImageGen, VideoGen, MusicGen, market data); aggregates <!-- br:models.chatVisible -->73<!-- /br:models.chatVisible --> models and accepts x402.
